...
const (
	AgentTaskTaskTypeAsync AgentTaskTaskType = "async"
	AgentTaskTaskTypeSync  AgentTaskTaskType = "sync"
)

// Valid indicates whether the value is a known member of the AgentTaskTaskType enum.
func (e AgentTaskTaskType) Valid() bool {
	switch e {
	case AgentTaskTaskTypeAsync:
		return true
	case AgentTaskTaskTypeSync:
		return true
	default:
		return false
	}
...
// Defines values for AgentTaskAsyncTriggerType.
const (
	ExternalSignal AgentTaskAsyncTriggerType = "external_signal"
	Scheduled      AgentTaskAsyncTriggerType = "scheduled"
)

// Valid indicates whether the value is a known member of the AgentTaskAsyncTriggerType enum.
func (e AgentTaskAsyncTriggerType) Valid() bool {
	switch e {
	case ExternalSignal:
		return true
	case Scheduled:
...
// Defines values for AgentTaskApprovalMode.
const (
	Auto     AgentTaskApprovalMode = "auto"
	Balanced AgentTaskApprovalMode = "balanced"
	Manual   AgentTaskApprovalMode = "manual"
)

// Valid indicates whether the value is a known member of the AgentTaskApprovalMode enum.
func (e AgentTaskApprovalMode) Valid() bool {
	switch e {
	case Auto:
		return true
	case Balanced:
...
// Defines values for AgentTaskPermissionMode.
const (
	Default  AgentTaskPermissionMode = "default"
	ReadOnly AgentTaskPermissionMode = "read-only"
)

// Valid indicates whether the value is a known member of the AgentTaskPermissionMode enum.
func (e AgentTaskPermissionMode) Valid() bool {
	switch e {
	case Default:
		return true
	case ReadOnly:
...
// Defines values for AgentTaskRuntimePhase.
const (
...
// Valid indicates whether the value is a known member of the AgentTaskRuntimePhase enum.
func (e AgentTaskRuntimePhase) Valid() bool {
	switch e {
...
func (e AgentTaskToolExecutionMode) Valid() bool {
	switch e {
...
// Defines values for AgentTaskSource.
const (
...
// Valid indicates whether the value is a known member of the AgentTaskSource enum.
func (e AgentTaskSource) Valid() bool {
	switch e {
...
// Defines values for AgentTaskVcsProvider.
const (
	AgentTaskVcsProviderAzureDevops      AgentTaskVcsProvider = "azure_devops"
	AgentTaskVcsProviderBitbucket        AgentTaskVcsProvider = "bitbucket"
	AgentTaskVcsProviderCustom           AgentTaskVcsProvider = "custom"
	AgentTaskVcsProviderGithub           AgentTaskVcsProvider = "github"
	AgentTaskVcsProviderGithubEnterprise AgentTaskVcsProvider = "github_enterprise"
	AgentTaskVcsProviderGitlab           AgentTaskVcsProvider = "gitlab"
)

// Valid indicates whether the value is a known member of the AgentTaskVcsProvider enum.
func (e AgentTaskVcsProvider) Valid() bool {
	switch e {
	case AgentTaskVcsProviderAzureDevops:
		return true
	case AgentTaskVcsProviderBitbucket:
		return true
	case AgentTaskVcsProviderCustom:
		return true
	case AgentTaskVcsProviderGithub:
		return true
	case AgentTaskVcsProviderGithubEnterprise:
		return true
	case AgentTaskVcsProviderGitlab:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the AppPolicyGroupSummaryEntityType enum.
func (e AppPolicyGroupSummaryEntityType) Valid() bool {
	switch e {
	case Accounts:
		return true
	case Stacks:
...
// Valid indicates whether the value is a known member of the AppPolicyGroupSummaryMode enum.
func (e AppPolicyGroupSummaryMode) Valid() bool {
	switch e {
	case AppPolicyGroupSummaryModeAudit:
		return true
	case AppPolicyGroupSummaryModePreventative:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the DeploymentJobStatus enum.
func (e DeploymentJobStatus) Valid() bool {
	switch e {
	case DeploymentJobStatusAccepted:
		return true
	case DeploymentJobStatusFailed:
		return true
	case DeploymentJobStatusNotStarted:
		return true
	case DeploymentJobStatusRunning:
		return true
	case DeploymentJobStatusSkipped:
		return true
	case DeploymentJobStatusSucceeded:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the DeploymentNestedUpdateResult enum.
func (e DeploymentNestedUpdateResult) Valid() bool {
	switch e {
	case DeploymentNestedUpdateResultFailed:
		return true
	case DeploymentNestedUpdateResultInProgress:
		return true
	case DeploymentNestedUpdateResultNotStarted:
		return true
	case DeploymentNestedUpdateResultSucceeded:
		return true
	default:
		return false
	}
...
const (
	...
	DeploymentNestedUpdateKindPdestroy DeploymentNestedUpdateKind = "Pdestroy"
	DeploymentNestedUpdateKindPimport  DeploymentNestedUpdateKind = "Pimport"
	DeploymentNestedUpdateKindPrefresh DeploymentNestedUpdateKind = "Prefresh"
	DeploymentNestedUpdateKindPrename  DeploymentNestedUpdateKind = "Prename"
	DeploymentNestedUpdateKindPreview  DeploymentNestedUpdateKind = "preview"
	DeploymentNestedUpdateKindPupdate  DeploymentNestedUpdateKind = "Pupdate"
...
// Valid indicates whether the value is a known member of the DeploymentNestedUpdateKind enum.
func (e DeploymentNestedUpdateKind) Valid() bool {
	switch e {
	case DeploymentNestedUpdateKindDestroy:
		return true
	case DeploymentNestedUpdateKindImport:
		return true
	case DeploymentNestedUpdateKindPdestroy:
		return true
	case DeploymentNestedUpdateKindPimport:
		return true
	case DeploymentNestedUpdateKindPrefresh:
		return true
	case DeploymentNestedUpdateKindPrename:
		return true
	case DeploymentNestedUpdateKindPreview:
		return true
	case DeploymentNestedUpdateKindPupdate:
		return true
	case DeploymentNestedUpdateKindRefresh:
		return true
	case DeploymentNestedUpdateKindRename:
		return true
	case DeploymentNestedUpdateKindUpdate:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ListDeploymentResponseStatus enum.
func (e ListDeploymentResponseStatus) Valid() bool {
	switch e {
	case ListDeploymentResponseStatusAccepted:
		return true
	case ListDeploymentResponseStatusFailed:
		return true
	case ListDeploymentResponseStatusNotStarted:
		return true
	case ListDeploymentResponseStatusRunning:
		return true
	case ListDeploymentResponseStatusSkipped:
		return true
	case ListDeploymentResponseStatusSucceeded:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ListDeploymentSnapshotPulumiOperation enum.
func (e ListDeploymentSnapshotPulumiOperation) Valid() bool {
	switch e {
	case ListDeploymentSnapshotPulumiOperationDestroy:
		return true
	case ListDeploymentSnapshotPulumiOperationDetectDrift:
		return true
	case ListDeploymentSnapshotPulumiOperationPreview:
		return true
	case ListDeploymentSnapshotPulumiOperationRefresh:
		return true
	case ListDeploymentSnapshotPulumiOperationRemediateDrift:
		return true
	case ListDeploymentSnapshotPulumiOperationUpdate:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ListDeploymentSnapshotStatus enum.
func (e ListDeploymentSnapshotStatus) Valid() bool {
	switch e {
	case ListDeploymentSnapshotStatusAccepted:
		return true
	case ListDeploymentSnapshotStatusFailed:
		return true
	case ListDeploymentSnapshotStatusNotStarted:
		return true
	case ListDeploymentSnapshotStatusRunning:
		return true
	case ListDeploymentSnapshotStatusSkipped:
		return true
	case ListDeploymentSnapshotStatusSucceeded:
		return true
	default:
		return false
	}
...
func (e OrganizationMemberRole) Valid() bool {
	...
	case OrganizationMemberRoleAdmin:
		return true
	case OrganizationMemberRoleBillingManager:
		return true
	case OrganizationMemberRoleMember:
		return true
	case OrganizationMemberRoleNone:
		return true
	case OrganizationMemberRolePotentialMember:
		return true
	case OrganizationMemberRoleStackCollaborator:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the PolicyViolationV2Kind enum.
func (e PolicyViolationV2Kind) Valid() bool {
	switch e {
	case PolicyViolationV2KindAudit:
		return true
	case PolicyViolationV2KindPreventative:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the StepRunStatus enum.
func (e StepRunStatus) Valid() bool {
	switch e {
	case Failed:
		return true
	case NotStarted:
...
// Valid indicates whether the value is a known member of the TeamKind enum.
func (e TeamKind) Valid() bool {
	switch e {
	case TeamKindGithub:
		return true
	case TeamKindPulumi:
...
// Valid indicates whether the value is a known member of the TeamUserRole enum.
func (e TeamUserRole) Valid() bool {
	switch e {
	case TeamUserRoleAdmin:
		return true
	case TeamUserRoleMember:
		return true
	case TeamUserRoleNone:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the TeamAccountPermissionPermission enum.
func (e TeamAccountPermissionPermission) Valid() bool {
	switch e {
	case TeamAccountPermissionPermissionN0:
		return true
	case TeamAccountPermissionPermissionN1:
		return true
	case TeamAccountPermissionPermissionN2:
		return true
	case TeamAccountPermissionPermissionN3:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the TeamEnvironmentSettingsPermission enum.
func (e TeamEnvironmentSettingsPermission) Valid() bool {
	switch e {
	case TeamEnvironmentSettingsPermissionAdmin:
		return true
	case TeamEnvironmentSettingsPermissionNone:
		return true
	case TeamEnvironmentSettingsPermissionOpen:
		return true
	case TeamEnvironmentSettingsPermissionRead:
		return true
	case TeamEnvironmentSettingsPermissionWrite:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the TeamMemberInfoRole enum.
func (e TeamMemberInfoRole) Valid() bool {
	switch e {
	case TeamMemberInfoRoleAdmin:
		return true
	case TeamMemberInfoRoleMember:
		return true
	case TeamMemberInfoRoleNone:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the TeamStackPermissionPermission enum.
func (e TeamStackPermissionPermission) Valid() bool {
	switch e {
	case TeamStackPermissionPermissionN0:
		return true
	case TeamStackPermissionPermissionN101:
		return true
	case TeamStackPermissionPermissionN102:
		return true
	case TeamStackPermissionPermissionN103:
		return true
	case TeamStackPermissionPermissionN104:
		return true
	default:
		return false
	}
...
const (
	Created    ListTasksParamsSortBy = "created"
	LastEvent  ListTasksParamsSortBy = "lastEvent"
	Name       ListTasksParamsSortBy = "name"
	Status     ListTasksParamsSortBy = "status"
	TokensUsed ListTasksParamsSortBy = "tokensUsed"
)

// Valid indicates whether the value is a known member of the ListTasksParamsSortBy enum.
func (e ListTasksParamsSortBy) Valid() bool {
	switch e {
	case Created:
		return true
	case LastEvent:
...
// Defines values for ListTasksParamsSortDirection.
const (
	Asc  ListTasksParamsSortDirection = "asc"
	Desc ListTasksParamsSortDirection = "desc"
)

// Valid indicates whether the value is a known member of the ListTasksParamsSortDirection enum.
func (e ListTasksParamsSortDirection) Valid() bool {
	switch e {
	case Asc:
		return true
	case Desc:
...
// Defines values for ListTasksParamsTaskType.
const (
	ListTasksParamsTaskTypeAsync ListTasksParamsTaskType = "async"
	ListTasksParamsTaskTypeSync  ListTasksParamsTaskType = "sync"
)

// Valid indicates whether the value is a known member of the ListTasksParamsTaskType enum.
func (e ListTasksParamsTaskType) Valid() bool {
	switch e {
	case ListTasksParamsTaskTypeAsync:
		return true
	case ListTasksParamsTaskTypeSync:
		return true
	default:
		return false
	}
...
type AgentTask struct {
	...
	// TaskType Whether the task was started synchronously by a user or asynchronously by background automation.
	TaskType AgentTaskTaskType `json:"taskType"`

	// AsyncTriggerType The async trigger source for this task. Null for sync tasks.
	AsyncTriggerType *AgentTaskAsyncTriggerType `json:"asyncTriggerType,omitempty"`
	...
	// ApprovalMode Approval mode for this task. Valid values: 'manual', 'auto', 'balanced'.
	ApprovalMode AgentTaskApprovalMode `json:"approvalMode"`

	// Entities Pulumi entities (stacks, projects, etc.) that provide context for the agent.
	Entities []AgentEntity `json:"entities"`

	// PlanMode Whether the task is in plan mode. Set based on the first user message.
	...
	// LastHeartbeat When the task runtime last reported a heartbeat. Null if the runtime has never checked in.
	LastHeartbeat *time.Time `json:"lastHeartbeat,omitempty"`

	// ContextUsedTokens Total input tokens consumed across all model invocations for this task. Approximate context window usage.
	ContextUsedTokens *int32 `json:"contextUsedTokens,omitempty"`

	// ContextWindowTokens Maximum context window size in tokens for the primary model used by this task.
	ContextWindowTokens *int32 `json:"contextWindowTokens,omitempty"`

	// ContextCompactionThresholdPercent Percentage of the context window (1-100) at which the agent triggers conversation compaction. Populated alongside contextWindowTokens when token usage data is available; omitted otherwise.
	ContextCompactionThresholdPercent *int32 `json:"contextCompactionThresholdPercent,omitempty"`

	// TokensUsed Total Neo tokens consumed across all model invocations for this task. Neo tokens are the priced unit used for billing — distinct from the raw model input tokens surfaced in contextUsedTokens / contextWindowTokens.
	TokensUsed int64 `json:"tokensUsed"`

	// ToolExecutionMode Where tools are executed for this task. Valid values: 'cloud', 'cli'.
	ToolExecutionMode *AgentTaskToolExecutionMode `json:"toolExecutionMode,omitempty"`

	// SourceAutomationID The automation that spawned this task, if the task was created by an automation run.
	SourceAutomationID *string `json:"sourceAutomationID,omitempty"`

	// Source The origin that triggered this task. Valid values: 'console', 'cli', 'slack', 'schedule', 'api', 'github', 'code-review'.
	Source *AgentTaskSource `json:"source,omitempty"`

	// VcsProvider The version control system this task operates against. Set for tasks that target a specific VCS platform (e.g. code reviews). Null for tasks with no VCS context.
	VcsProvider *AgentTaskVcsProvider `json:"vcsProvider,omitempty"`
}

// AgentTaskTaskType Whether the task was started synchronously by a user or asynchronously by background automation.
type AgentTaskTaskType string

// AgentTaskAsyncTriggerType The async trigger source for this task. Null for sync tasks.
type AgentTaskAsyncTriggerType string

// AgentTaskStatus Current execution status of the task.
type AgentTaskStatus string

// AgentTaskApprovalMode Approval mode for this task. Valid values: 'manual', 'auto', 'balanced'.
type AgentTaskApprovalMode string

// AgentTaskPermissionMode The permission scope for the task.
type AgentTaskPermissionMode string

// AgentTaskRuntimePhase The current runtime phase for this task. Null until the runtime checks in.
type AgentTaskRuntimePhase string

// AgentTaskToolExecutionMode Where tools are executed for this task. Valid values: 'cloud', 'cli'.
type AgentTaskToolExecutionMode string

// AgentTaskSource The origin that triggered this task. Valid values: 'console', 'cli', 'slack', 'schedule', 'api', 'github', 'code-review'.
type AgentTaskSource string

// AgentTaskVcsProvider The version control system this task operates against. Set for tasks that target a specific VCS platform (e.g. code reviews). Null for tasks with no VCS context.
type AgentTaskVcsProvider string
...
type DeploymentNestedUpdate struct {
	...
	// UpdateID Identifier of the underlying Pulumi CLI update operation.
...
// FGARole A role assigned to an organization member, identified by ID and name. The role may be a built-in role or a custom role.
type FGARole struct {
...
type OrgEnvironment struct {
	...
	// OwnedBy UserInfo contains just the display information for a user.  This information may be returned from public APIs,
	// and as such this structure must not contain sensitive information.  Please refer to User for this sort of thing.
	OwnedBy UserInfo `json:"ownedBy"`
...
type OrganizationMember struct {
	...
	// Teams Deprecated. Use GetOrganizationMemberTeams to list teams.
	// Deprecated: this property has been marked as deprecated upstream, but no `x-deprecated-reason` was set
	Teams *[]string `json:"teams,omitempty"`
}

// OrganizationMemberRole **Deprecated:** Use `fgaRole` instead. The member's built-in role within the organization. For members assigned a custom role, this is the closest built-in projection (`member`, `admin`, or `billingManager`) and may lose detail; `fgaRole` is authoritative.
...
type TeamEnvironmentSettings struct {
	...
	// MaxOpenDuration The maximum duration an environment session can remain open, as a Go duration string (e.g. "1h30m").
...
type ListOrgEnvironmentsEscParams struct {
	...
	// IncludeReferrerMetadata Deprecated. No longer used; referrer metadata is no longer computed and this parameter is ignored.
...
type ListTasksParams struct {
	...
	// SortBy Field to sort the results by. Defaults to lastEvent.
	SortBy *ListTasksParamsSortBy `form:"sortBy,omitempty" json:"sortBy,omitempty"`

	// SortDirection Direction to sort the results in. Defaults to desc.
	SortDirection *ListTasksParamsSortDirection `form:"sortDirection,omitempty" json:"sortDirection,omitempty"`

	// TaskType Task type to filter by
	TaskType *ListTasksParamsTaskType `form:"taskType,omitempty" json:"taskType,omitempty"`
}

// ListTasksParamsSortBy defines parameters for ListTasks.
type ListTasksParamsSortBy string

// ListTasksParamsSortDirection defines parameters for ListTasks.
type ListTasksParamsSortDirection string

// ListTasksParamsTaskType defines parameters for ListTasks.
type ListTasksParamsTaskType string
...
type GetStackUpdatesParams struct {
	...
	// PageSize Number of results per page. Must be >= 0; defaults to 10. Ignored when page is 0, which returns all results.
	PageSize *int64 `form:"pageSize,omitempty" json:"pageSize,omitempty"`
}
...
func NewListOrgEnvironmentsEscRequest(server string, orgName string, params *ListOrgEnvironmentsEscParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.IncludeReferrerMetadata != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "includeReferrerMetadata", *params.IncludeReferrerMetadata, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "boolean", Format: ""}); err != nil {
				return nil, err
			} else {
				for _, qp := range strings.Split(queryFrag, "&") {
					rawQueryFragments = append(rawQueryFragments, qp)
...
func NewListOrgDeploymentsRequest(server string, orgName string, params *ListOrgDeploymentsParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.Asc != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "asc", *params.Asc, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "boolean", Format: ""}); err != nil {
				return nil, err
			} else {
				for _, qp := range strings.Split(queryFrag, "&") {
					rawQueryFragments = append(rawQueryFragments, qp)
...
func NewListPolicyPacksOrgsRequest(server string, orgName string, params *ListPolicyPacksOrgsParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.Policypack != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "policypack", *params.Policypack, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: ""}); err != nil {
				return nil, err
			} else {
				for _, qp := range strings.Split(queryFrag, "&") {
					rawQueryFragments = append(rawQueryFragments, qp)
...
func NewListStackDeploymentsHandlerV2Request(server string, orgName string, projectName string, stackName string, params *ListStackDeploymentsHandlerV2Params) (*http.Request, error) {
	...
	pathParam2, err = runtime.StyleParamWithOptions("simple", false, "stackName", stackName, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "string", Format: ""})
	if err != nil {
		return nil, err
	}
...
func NewGetStackUpdatesRequest(server string, orgName string, projectName string, stackName string, params *GetStackUpdatesParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.OutputType != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "output-type", *params.OutputType, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: ""}); err != nil {
				return nil, err
			} else {
				for _, qp := range strings.Split(queryFrag, "&") {
					rawQueryFragments = append(rawQueryFragments, qp)
...
func NewListUserStacksRequest(server string, params *ListUserStacksParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.TagName != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "tagName", *params.TagName, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: ""}); err != nil {
				return nil, err
			} else {
				for _, qp := range strings.Split(queryFrag, "&") {
					rawQueryFragments = append(rawQueryFragments, qp)
		...
		if params.TagValue != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "tagValue", *params.TagValue, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: ""}); err != nil {
				return nil, err
			} else {
				for _, qp := range strings.Split(queryFrag, "&") {
					rawQueryFragments = append(rawQueryFragments, qp)
...
func (r ListOrgEnvironmentsEscResp) ContentType() string {
	if r.HTTPResponse != nil {
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r ListOrgDeploymentsResp) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r ListPolicyGroupsResp) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r ListPolicyPacksOrgsResp) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r GetPolicyResultsMetadataResp) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r ListPolicyViolationsV2Resp) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r ListTeamsResp) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r ListStackDeploymentsHandlerV2Resp) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r GetStackResourceCountResp) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r GetStackUpdatesResp) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r ListUserStacksResp) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
